...
<%! HttpSession s = null; %>
    ...
    <span class="title">
        <a href="mainPageAfterLogin.jsp">
          <img src=".\img\title.PNG" width="500px" height="150px"/>
        </a>
    </span>
...
<div id="totalBackground">
  ...
  <div id="deal">
    ...
    <input id="deal_btn" type="submit" name="liking" value="<%=deal %>" />
  </div>
  </form>
  <span>
    <img src="<%=".\\Upload\\"+productImgUrl %>" width="600" height="700"/><br/><br/><br/>
    가격: <%=price %><br/><br/>
    카테고리: <%=productCategory %> <br/><br/>
    연락처: <%=phonenumber %><br/><br/>
    대여기간: <%=lendingPeriod %><br/><br/>
    설명: <%=productInformation %><br/><br/>
  </span>
  <form method="post" action="doIncreaseLike">
  <div id="liking">
  	<input type="hidden" name="likenum" value="<%=productNo %>"/>
    <input id="liking_btn" type="submit" name="liking" value="좋아요<%=productLike%>" onClick="increaseLike()"/>
  </div>
  </form>
  <div id="deal">
    <input id="notice_toList" type="submit" name="liking" onClick="location.href='borrowList.jsp'" value="목록으로" onClick="increaseLike()"/>
  </div>
  <br/><br/>
  <div id="main_ad6">
      <h2>Share Things</h2>
     <address>
  2020 Copyright&copy;ShareThings. All Rights Reserved.
  </address>
      <ul>
    <li id="main_ad6_subtitle">
      <a href="notice.jsp"> 공지사항 </a>|
      <a href="terms.html"> 이용약관 </a>  |
      <a href="customerService.html"> 고객문의 </a>  |
      <a href="AdService.html"> 광고문의 </a> 
    </ul>
  </div>
  </div>
